...
impl CaptureMode{
    ...
    pub fn update(&mut self, ui: &mut egui::Ui,  ctx: &egui::Context, _frame: &mut eframe::Frame) -> Option<(ScreenshotDim, f64)> 
    {
        let mut ret = None;
        ...
        ui.horizontal(|ui|
            {
                ...
                .selected_text(format!("{:?}", screens_manager.get_current_screen_index()+1))
                .show_ui(ui, |ui|{
                    ui.style_mut().wrap = Some(false);
                    ui.set_min_width(60.0);
